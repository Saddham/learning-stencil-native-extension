# learning-stencil-native-extension
...
```
replace github.com/getoutreach/learning-stencil-native-extension => /path/to/local/version/learning-stencil-native-extension
```
